...
public class Objetivo
{
     ...
     * los objetivos a nuestar manera
     * @return mensaje Descripción general del objetivo
     */
    @Override
    public String toString (){
        String mensaje="Descripcion: "+descripcion + "Estado: ";
        if(completado){ mensaje+="completado";} else {mensaje+="Incompleto";}
        return mensaje;
    }
}